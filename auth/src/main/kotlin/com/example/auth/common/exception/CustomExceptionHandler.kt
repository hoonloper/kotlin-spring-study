...
class CustomExceptionHandler {
    ...
    protected fun invalidInputException(ex: BadCredentialsException): ResponseEntity<BaseResponse<Map<String, String>>> {
    ...
    protected fun invalidInputException(ex: Exception): ResponseEntity<BaseResponse<Map<String, String>>> {
